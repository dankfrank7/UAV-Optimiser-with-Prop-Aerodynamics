...
saveFilename = 'WingTips_NoProp_30span_DRIES_RESULTS'; % Change name of results file HERE!!!!
% 'TestVariablesDate.mat'; 

%
% NOTES: 30 cm class based off Ben VMGill theis 
%
...
SETTINGS.propellerName  = 'noProp'; % noProp to turn off prop
SETTINGS.blades         = '2';
