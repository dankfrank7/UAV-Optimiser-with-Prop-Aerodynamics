...
saveFilename = 'Genmav_GWS5x43_45span_DRIES_RESULTS'; % Change name of results file HERE!!!!
...
SETTINGS.propellerName  = 'GWS5x43'; % noProp to turn off prop
SETTINGS.blades         = '2';
SETTINGS.noRotorSpanEle = 6;
SETTINGS.pitchShift     = 15;
SETTINGS.propDiam       = 0.127;
