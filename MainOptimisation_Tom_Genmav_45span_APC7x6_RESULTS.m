...
saveFilename = 'Genmav_APC7x6_45span_DRIES_RESULTS'; % Change name of results file HERE!!!!
% 'TestVariablesDate.mat'; 

%
% NOTES: This is the final version after incorrect prop diam Sun 31/10/2021
%
...
SETTINGS.systemWeight   = 0.223; % Adjusted for 7 in prop
...
SETTINGS.pitchShift     = 4;
SETTINGS.propDiam       = 0.1778;
...
% Prop Iter Testing
SETTINGS.rpm        = 60*SETTINGS.speed./0.6/SETTINGS.propDiam;
omega = SETTINGS.rpm*2*pi/60;
dt    = deg2rad(SETTINGS.dAngle)/omega; 
SETTINGS.delta_time     = dt;

% Variable waiting room 
SETTINGS.rpm        = 60*SETTINGS.speed./0.6/SETTINGS.propDiam; % Change this to advance ratio?
SETTINGS.taper         = 0.4;
SETTINGS.l_vt          = 1.6;% x-position of leading edge * c_root
SETTINGS.sweep_vt      = nan; % nan changes sweep to keep trailing edge straight
SETTINGS.sweep_vt2     = nan;
SETTINGS.ar_vt2        = 0.5;
SETTINGS.volumeTail2   = 0.15;% Lower tail 
SETTINGS.taper_vt2     = 0.7;
SETTINGS.twist         = 2;
