...
%--------------------------------------------------------------------------
    ...
    if nargin == 2
        ...
        PopCon = varargin{2};
        nSort  = varargin{3};
        Infeasible           = any(PopCon>0,2); %#TODO: make sure that all equality constraints are set to absolute to allow for the count here to work.
...
%TODO: implement different constraint handling strategies here. Look at
%strategies used in the ensemble of constraint handling for MO problems
